...
TEST_F(CollectionVectorTest, TestQAConversation) {
    ...
    auto results_op = coll->search("how many products are there for clothing category?", {"embedding"},
                                 ...
                                 true, 0, max_score, 100, 0, 0, 0, "exhaustive", 30000, 2, "", {}, {}, "right_to_left", true, true, true,
...
TEST_F(CollectionVectorTest, HybridSearchWithFilteringAndFlatSearchCutoff) {
    nlohmann::json schema = R"({
                "name": "test",
                "fields": [
                    {
    ...
    auto res = coll->search("footwear", {"name", "embedding"}, "age:>0", {},
...
nlohmann::json schema = R"({
    ...
    std::string vector_query_with_bad_image = "embedding:([], image: bad_image)";

    vector_query_t q;
    auto parse_op = VectorQueryOps::parse_vector_query_str(vector_query_with_bad_image, q, true, coll1, false);

    ASSERT_FALSE(parse_op.ok());
    ASSERT_EQ("Malformed vector query string: could not embed image.", parse_op.error());

    std::string vector_query_with_image = "embedding:([], image: ";
    vector_query_with_image += "";
    vector_query_with_image += ")";
    q._reset();
